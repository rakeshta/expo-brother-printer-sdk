...
internal class ChannelUtils {
     ...
     */
    internal static func withPrinterDriver<T>(_ channelDict: [String: Any], operation: (BRLMPrinterDriver, String) throws -> T) throws -> T {
        // Reconstruct channel
        ...
        guard let modelName = (channel.extraInfo?[BRLMChannelExtraInfoKeyModelName] ?? channelDict["modelName"]) as? String else {
